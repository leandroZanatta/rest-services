...
public class DocumentoEletronicoNumeroDOC {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((codigoDocumentoEletronicoSerie == null) ? 0 : codigoDocumentoEletronicoSerie.hashCode());
    ...
    public String toString() {
        return "DocumentoEletronicoNumeroDOC [id=" + id + ", codigoDocumentoEletronicoSerie=" + codigoDocumentoEletronicoSerie + ", ambiente="
                + ambiente + ", ultimoNumeroUtilizado=" + ultimoNumeroUtilizado + ", dataCadastro=" + dataCadastro + ", dataManutencao="
                + dataManutencao + ", hashCode()=" + hashCode() + ", getId()=" + getId() + ", getCodigoDocumentoEletronicoSerie()="
                + getCodigoDocumentoEletronicoSerie() + ", getAmbiente()=" + getAmbiente() + ", getUltimoNumeroUtilizado()="
                + getUltimoNumeroUtilizado() + ", getDataCadastro()=" + getDataCadastro() + ", getDataManutencao()=" + getDataManutencao() + "]";
    }

    public DocumentoEletronicoNumeroDOC(Long id, Long codigoDocumentoEletronicoSerie, String ambiente, Long ultimoNumeroUtilizado, Date dataCadastro,
            Date dataManutencao) {
        super();
        this.id = id;
        this.codigoDocumentoEletronicoSerie = codigoDocumentoEletronicoSerie;
